...
class Fluxes {
  ...
  protected:
    ...
    double m_power2_c, m_power2_alpha;
    ...
    /**
     * Compute the generic planet-limb integrand factor for a power-law
     * intensity term mu^alpha.
     */
    double zeta_power_term(double zp, double alpha);

    /**
     * Derivative of zeta_power_term with respect to zp.
     */
    double dzeta_power_term_dzp(double zp, double alpha);

    /**
     * Derivative of zeta_power_term with respect to alpha.
     */
    double dzeta_power_term_dalpha(double zp, double alpha);
