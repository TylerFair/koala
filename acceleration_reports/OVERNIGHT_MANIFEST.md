...
- 2026-09-02 CDT: restricted automatic Jacobian LD coordinates to power-2, diagnosed the quadratic Kipping support leak, and validated the 68-channel coefficient production swap (53 NUTS/9 HMC/6 adaptive; shape consistent with legacy); see `defaults_and_ld_reparam.md`.
